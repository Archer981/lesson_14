...
cur = con.cursor()
sqlite_query = """
               select title as 'Название', release_year as 'Дата выпуска в прокат',
               description as 'Описание', rating as 'Возрастной рейтинг'
               from netflix where description like '%programmer%'
